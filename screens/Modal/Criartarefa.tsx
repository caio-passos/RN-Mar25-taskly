        ...
        >
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    <Text style={styles.titleText} numberOfLines={1}>Criar tarefa </Text>
                        ...
                        <View style={styles.inputForm}>
                            ...
                            <View style={styles.boxInput}>
                                <TextInput
                                    ...
                                    multiline={true}
                                    onChangeText={(value) => setDescrição(String(value))}
                                />
                            </View>
                        </View>
                        <View style={styles.inputForm}>
                        ...
                        <View style={styles.boxButtons}>
                            ...
                            >
                                <Pressable
                                    onPress={onClose}
                                >
                                    <Text style={[styles.buttonText, { color: '#FFFFFF' }]}>CRIAR</Text>
                                </Pressable>
                            </Pressable>
